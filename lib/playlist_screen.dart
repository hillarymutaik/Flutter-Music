...
class _PlaylistScreenState extends State<PlaylistScreen>
              ...
              return AnimatedList(
                itemBuilder: (context, index, animation) {
                  return SoundWaveState.currentPlaylist[index]
                      .buildPlaylistWidget(context, () {
                    changeSong(index);
                  }, () {
                    removeAt(index);
                  },
                          active:
                              index == SoundWaveState.currentPlaylist.active,
                          playing:
                              SoundWaveState.currentPlaylist.active == index &&
                                  playing);
                },
  ...
  void removeAt(int index) {
    if (index == SoundWaveState.currentPlaylist.active) return;
