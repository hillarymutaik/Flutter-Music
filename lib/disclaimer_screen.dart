...
class DisclaimerScreenState extends State<DisclaimerScreen> {
        ...
        child: CupertinoButton(
            ...
            onPressed: () {
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) => SoundWave()));
            }),
      ),
    );
  }
  ...
  Widget body() {
    return Container(
      ...
      child: Text(
        "Hey there. Bungee is an app that is created just for developer's purpose.I do not own any music resource.If you are owner of song you can email me at singhbhavneetdeveloper@gmail.com, just dont report app on play store please!! 😊."
