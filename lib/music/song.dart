...
class Details {
  ...
  static var placeholders = {
    "song": "images/music_placeholder.png",
    "album": "images/album_placeholder.png",
    "artist": "images/artist_placeholder.png",
  };
            ...
            Stack(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Icon(
                    logo,
                    color: type == "artist" ? Colors.transparent : Colors.white,
                  ),
                )
              ],
            ),
  ...
  Widget buildCollectionsWidget(
      BuildContext context, Function callback, Function notInterested,
  ...
  Widget buildTrendingWidget(
      BuildContext context, Function callback, int index) {
    double size = 135.0;
    return CupertinoButton(
      minSize: 0.0,
      padding: EdgeInsets.all(0.0),
...
class Song extends Details {
  ...
  Song(
      ...
      this.url});
  String get link =>
      links.length > 1 ? links[1] : (links.length == 1 ? links[0] : "");
    ...
    return CupertinoButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            color: Color(0xff715458).withOpacity(0.4)),
        child: Row(
          children: <Widget>[
            Container(
              decoration: BoxDecoration(
              ...
              subtitle: Padding(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.subtitle1.copyWith(
                      fontFamily: "GoogleSans", fontStyle: FontStyle.normal),
                  textAlign: TextAlign.center,
                ),
              ),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(artists.join(" - "),
                    style: Theme.of(context)
                        .textTheme
                        .subtitle1
                        .copyWith(fontSize: 18.0, height: 1.2),
                    textAlign: TextAlign.center),
              ),
            ],
          ),
...
class Artist extends Details {
  ...
  static Artist fromMap(map) {
    return Artist(
        title: map[DatabaseInterface.title],
