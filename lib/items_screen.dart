  ...
  Widget getSongs() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        if (gridView) {
          return items[index].buildGridItem(context, () {
            callback(index);
          });
        } else {
          return items[index].buildItemWidget(context, () {
            callback(index);
          });
        }
      },
  ...
  void callback(index) {
    if (items[index] is Song) {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        ...
        items[index].url.startsWith("userData")) {
      Navigator.of(context).push(MaterialPageRoute(builder: (context) {
        return ItemsScreen(items[index]);
      }));
    } else {
            ...
            actions: <Widget>[
              CupertinoActionSheetAction(
                  ...
                  child: FlatButton.icon(
                    ...
                    icon: Icon(
                      !gridView ? Icons.view_quilt : Icons.view_list,
                      color: Colors.black,
                    ),
                    label: Text(
  ...
  void _getMoreData() {
    ...
    if (scaffoldKey.currentState != null) {
      scaffoldKey.currentState.showSnackBar(SnackBar(
        content: Text("Loading more data"),
