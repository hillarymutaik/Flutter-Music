      ...
      builder: (context, snapshot) {
          ...
          return SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                ListTile(
                  title: Text("Its pretty quit in here",
        ...
        return AnimatedList(
          ...
          itemBuilder: (context, index, animation) {
            ...
            return _itemBuilder.buildSearchItem(items[index - 1],
                trailing: IconButton(
                    icon: Icon(
                      Icons.clear,
                    ),
    ...
    return CupertinoButton(
      ...
      onPressed: () {
        Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => MoreScreen(key, type)));
      },
    );
  }
