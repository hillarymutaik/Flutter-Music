  ...
  void showDetails()
  {
    ...
    menuItems.add(Padding(
      ...
      child: ListTile(
        ...
        subtitle: song is Song?Text(song.artist,style: Theme.of(context).textTheme.subtitle1,):Text(song.type[0].toUpperCase()+song.type.substring(1),style: Theme.of(context).textTheme.subtitle1,),
      ),
    ));
    ...
    if(widget.song is Song)
      {
        ...
        menuItems.add(ListTile(
          ...
          title: Text("Add to Playlist",style: Theme.of(context).textTheme.titleMedium,),
          onTap: (){
         ...
         if(widget.showPlay)
           {
             ...
             menuItems.add(ListTile(
               ...
               title: Text("Play next",style: Theme.of(context).textTheme.titleMedium,),
             ));
             menuItems.add(ListTile(
               onTap: (){
               ...
               title: Text("Add to End of Queue",style: Theme.of(context).textTheme.titleMedium,),
             ));
           }
            ...
            builder:(context,snapshot)
            {
              if(!snapshot.hasData)
              {
                ListTile(
                  ...
                  title: Text("Like",style: Theme.of(context).textTheme.titleMedium,),
                );
              }
              ...
              return  ListTile(
                ...
                title: Text(isliked?"Dislike":"Like",style: Theme.of(context).textTheme.titleMedium,),
              );
            }),
        onPressed:(){
          if(isliked)
