...
class ItemBuilder {
      ...
      child: Column(
        children: <Widget>[
          ListTile(
            ...
            trailing: MoreButton(
                Details(title: "Editorial Picks", url: "library/top 20 songs")),
          ),
          ListView.builder(
            itemBuilder: (context, index) {
              return songs[index].buildItemWidget(
                context,
                () {
                  play(songs, index);
                },
        ...
        children: <Widget>[
          Padding(
              ...
              child: ListTile(
                ...
                trailing: MoreButton(Details(
                    title: "Top Albums", url: "library/top punjabi albums")),
              )),
          Container(
            height: 258.0,
          ...
          Padding(
              ...
              child: ListTile(
                ...
                trailing: axis == Axis.horizontal
                    ? MoreButton(Details(title: "Artists", url: "artists"))
                    : null,
              )),
          Container(
            ...
            child: ListView.builder(
              itemBuilder: (context, index) {
                return axis == Axis.horizontal
                    ? artists[index].buildWidget(context, () {
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: ListView.builder(
            itemBuilder: (context, index) {
              return playlist.buildPlaylistCover(context, () {
                showAlbumScreen(playlist[index]);
              });
            },
            physics: ClampingScrollPhysics(),
            itemCount: songs.length,
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          child: ListView.builder(
            itemBuilder: (context, index) {
              return songs[index].buildRecentWidget(
                context,
                () {
                  play(songs, index);
                },
  ...
  Widget createPlaylistButton(List<Song> songs) {
    return Center(
      ...
      onPressed: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
          return CollectionsScreen(songs: songs);
        }));
      },
      shape: CircleBorder(),
      color: Colors.white,
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView.builder(
              itemBuilder: (context, index) {
                return buildRelatedWidget(items[index], () {
                  showAlbumScreen(items[index]);
                });
              },
              physics: BouncingScrollPhysics(),
          ...
          children: <Widget>[
            Container(
              decoration: BoxDecoration(
                  color: Color(0xfffeee6ff),
                  borderRadius: data.type == "artist"
              ...
              child: ClipRRect(
                ...
                child: FadeInImage.assetNetwork(
                  placeholder: Details.placeholders[data.type],
        ...
        children: <Widget>[
          Padding(
              ...
              child: ListTile(
                ...
                trailing:
                    MoreButton(Details(title: "Categories", url: "genres")),
              )),
          Container(
            height: 250.0,
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return categories[index].buildWidget(context, () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => ItemsScreen(categories[index])));
                });
              },
              physics: BouncingScrollPhysics(),
