...
class _PlayScreenState extends State<PlayScreen>
  ...
  void initState() {
    ...
    subscription = SoundWaveState.publishSubject.listen((Command command) {
      ...
      if (command.command == Command.index &&
          controller != null &&
          controller.page.toInt() != command.data) {
        controller.jumpToPage(command.data);
      }
      if (command.command == Command.remove &&
          controller != null &&
          controller.page.toInt() != SoundWaveState.currentPlaylist.active) {
    ...
    controller =
        PageController(initialPage: SoundWaveState.currentPlaylist.active);
  }
      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: Text(
                  "Sometimes song may take time to load may be more than 30s so be patient"),
              actions: <Widget>[
                FlatButton(
                    onPressed: () {
    ...
    return Stack(
      children: <Widget>[
        FadeInImage.assetNetwork(
          ...
          image: SoundWaveState.currentPlaylist.activeSong.thumbnail,
        ...
        Scaffold(
            ...
            body: Column(
              ...
              children: <Widget>[cover, playControls],
            )),
      ],
    );
  }
  ...
  AppBar createAppbar() {
    return AppBar(
      ...
      leading: IconButton(
        icon: ImageIcon(
          AssetImage("images/back_navigation.png"),
          size: 20.0,
        ),
        onPressed: () {
          Navigator.of(context).pop();
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  SoundWaveState.currentPlaylist.activeSong.title,
              ...
              DotsIndicator(
                initialPage: SoundWaveState.currentPlaylist.active,
                itemCount: SoundWaveState.currentPlaylist.length >= 3
                    ? 3
                    : SoundWaveState.currentPlaylist.length,
      ...
      actions: <Widget>[
        Padding(
          ...
          child: MenuButton(
            SoundWaveState.currentPlaylist.activeSong,
            showPlay: false,
            color: Colors.white,
          ),
        )
        ...
        children: <Widget>[
          Padding(
            ...
            child: ListTile(
              ...
              subtitle: Padding(
                ...
                child: Text(
                  SoundWaveState.currentPlaylist.activeSong.artist,
                  style: Theme.of(context)
                      .textTheme
                      .subtitle1
          ...
          Padding(
            ...
            child: Slider(
              ...
              min: 0.0,
              max: SoundWaveState.duration.inSeconds.ceilToDouble(),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Text(
                  time(Duration(seconds: currentPosition.toInt())),
                  style: TextStyle(color: Colors.white, fontSize: 12.0),
                ),
                Text(
                  time(SoundWaveState.duration),
                  style: TextStyle(color: Colors.white, fontSize: 12.0),
                )
              ],
            ),
          ...
          Row(
            ...
            children: <Widget>[
              ...
              IconButton(
                  ...
                  onPressed: SoundWaveState.currentPlaylist.active <= 0
                      ? null
                      : () {
                          controller.jumpToPage(
                              SoundWaveState.currentPlaylist.active - 1);
                        },
                  color: Colors.white),
              PlayButton(
                size: 64.0,
              ...
              IconButton(
                  ...
                  disabledColor: Color(0xff616161),
                  onPressed: SoundWaveState.currentPlaylist.active ==
                          SoundWaveState.currentPlaylist.length - 1
                      ? null
                      : () {
                          controller.jumpToPage(
                              SoundWaveState.currentPlaylist.active + 1);
  ...
  Widget playButton() {
    if (SoundWaveState.disabled) {
      ...
      disableButton = false;
      return IconButton(
        icon: Icon(SoundWaveState.currentPlaylist.playing
            ? Icons.pause
            : Icons.play_arrow),
    ...
    return Expanded(
      child: PageView.builder(
        itemBuilder: (context, index) {
          return SoundWaveState.currentPlaylist[index]
              .buildPlayCoverWidget(context, () {});
        },
        controller: controller,
        onPageChanged: (index) {
  ...
  String kUrl =
      "http://khalsaonline.net/Mp3/Nitnem/load/Nitnem/Paath/Chaupai%20Sahib/Bhai%20Jarnail%20Singh%20-%20Chaupai%20Sahib%20%20.mp3";
}
